 ...
 * @File: Util.java
 * @Package com.example.cyan
 * @date 12/10/23 8:36 PM
 * @Description: Encapsulate the process of using some necessary utils in this class.
 */
public class Util {

    private static final String myEmailAccount = "810680557@qq.com";
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress(myEmailAccount, "DaoWen Yang", "UTF-8"));
                    ...
                    Transport.send(msg, myEmailAccount, "jpyqaroptuvbbdjf");
